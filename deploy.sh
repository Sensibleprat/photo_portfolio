...
echo ""
echo "Your portfolio changes have been pushed to GitHub!"
echo "If you have connected Cloudflare Pages, your site will be live in ~1 minute."
echo ""
echo "💡 Tip: Check your deployment status at:"
